...
HD_PWD='C:/Users/osher/Vivado2020.1_Project/Decimal_Counter_3D/Decimal_Counter_3D.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DecimalCounter_3D.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DecimalCounter_3D.tcl -notrace
