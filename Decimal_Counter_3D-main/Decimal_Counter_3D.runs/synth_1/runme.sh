...
HD_PWD='C:/Users/osher/Vivado2020.1_Project/Decimal_Counter_3D/Decimal_Counter_3D.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DecimalCounter_3D.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DecimalCounter_3D.tcl
